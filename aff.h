...
int choix (void){
    int i,x=0,y=0,ch;
    chaine lechoix[]={ "   >>   Afficher un fichier page par page   <<   ",
...
delay(500);
  ...
  //**********************************************************************************************************************
    ...
    textcolor(10);
        ...
        printdirection("Annee Universitaire 2017/2018","right",49,2,45) ;
        decalrectangle(2);
        textcolor(2);
textbackground(0);
gotoxy(35,10);
...
printdirection("yo5 ","down",57,23,60);
...
printdirection(" | Semestre 03","right",80,24,30);
printdirection("> Encadree par :       Dr A.KERMI","right",20,27,45);
textbackground(0);
...
gotoxy(15,10);
    ...
    printdirection(" Kadi Fouad ","right",85,16,15);
        textbackground(15);textcolor(0);
     printdirection(" e-mail: gf_kadi@esi.dz ","right",79,18,15);
